...
!(function (n) {
  ...
  var s = function (e, t) {
    ...
    t &&
      ...
      (this.opts = w.extend(!0, {}, w.extend({}, s.DEFAULTS, n, "object" == typeof t && t)));
    var r = JSON.stringify(this.opts);
    (w.FE.OPTS_MAPPING[r] = w.FE.OPTS_MAPPING[r] || this.id),
      (this.sid = w.FE.OPTS_MAPPING[r]),
      (w.FE.SHARED[this.sid] = w.FE.SHARED[this.sid] || {}),
      (this.shared = w.FE.SHARED[this.sid]),
    ...
    this.$oel.on(
      ...
      w.proxy(function () {
        this.$oel.off("froala.doInit"),
          ...
          (this.$doc = w(this.doc)),
          (this.$win = w(this.win)),
          this.opts.pluginsEnabled || (this.opts.pluginsEnabled = Object.keys(w.FE.PLUGINS)),
          this.opts.initOnClick
            ? (this.load(w.FE.MODULES),
              ...
              this.$el.on(
                ...
                w.proxy(function (e) {
                  ...
                  if (1 === e.which || !e.which) {
                    ...
                    t && "IMG" == t.tagName && w(t).trigger("mousedown"),
                      "undefined" == typeof this.ul && this.destroy(),
                      "touchend" == e.type &&
                        this.image &&
                        e.originalEvent &&
                        e.originalEvent.target &&
                        w(e.originalEvent.target).is("img") &&
                        setTimeout(
                          w.proxy(function () {
            ...
            : (this.load(w.FE.MODULES), this.load(w.FE.PLUGINS), w(this.o_win).scrollTop(o), "undefined" == typeof this.ul && this.destroy(), (this.ready = !0), this.events.trigger("initialized"));
      }, this)
    ),
      this._init();
  };
  (s.DEFAULTS = { initOnClick: !1, pluginsEnabled: null }),
    ...
    (s.prototype._init = function () {
      ...
      var t = w.proxy(function () {
          "TEXTAREA" != e && (this._original_html = this._original_html || this.$oel.html()),
            ...
            this.opts.iframe
              ? ((this.$iframe = w('<iframe src="about:blank" frameBorder="0">')),
                (this.$wp = w("<div></div>")),
              ...
              : ((this.$el = w("<div></div>")), (this.el = this.$el.get(0)), (this.$wp = w("<div></div>").append(this.$el)), this.$box.html(this.$wp)),
          ...
          this.each(function () {
            ...
            if (e) {
              ...
              if ((0 < o.indexOf(".") && e[o.split(".")[0]] ? (e[o.split(".")[0]] && (t = e[o.split(".")[0]]), (n = o.split(".")[1])) : ((t = e), (n = o.split(".")[0])), !t[n]))
                return w.error("Method " + o + " does not exist in Froala Editor.");
    ...
    (w.fn.froalaEditor.Constructor = s),
    (w.FroalaEditor = s),
    (w.FE = s),
    (w.FE.XS = 0),
    (w.FE.SM = 1),
    (w.FE.MD = 2),
    (w.FE.LG = 3);
  (w.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}"),
    (w.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())"),
    (w.FE.LinkRegExTLD = "((" + w.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"),
    (w.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + w.FE.LinkRegExCommon + ")"),
    (w.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + w.FE.LinkRegExCommon + ")"),
    (w.FE.LinkRegExWWW = "(www\\." + w.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})"),
    (w.FE.LinkRegEx = "(" + w.FE.LinkRegExTLD + "|" + w.FE.LinkRegExHTTP + "|" + w.FE.LinkRegExWWW + "|" + w.FE.LinkRegExAuth + ")" + w.FE.LinkRegExEnd),
    (w.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"]),
    (w.FE.MAIL_REGEX = /.+@.+\..+/i),
    (w.FE.MODULES.helpers = function (i) {
      function e() {
        var e,
          t,
          n = {},
      ...
      return {
        ...
        sanitizeURL: function (e) {
          return /^(https?:|ftps?:|)\/\//i.test(e)
            ...
            ? e
            : new RegExp("^(" + w.FE.LinkProtocols.join("|") + "):\\/\\/", "i").test(e)
            ? e
    ...
    (w.FE.MODULES.node = function (a) {
      ...
      return {
        ...
        isEmpty: function (e, t) {
          ...
          return !(
            e.querySelectorAll(w.FE.VOID_ELEMENTS.join(",")).length - e.querySelectorAll("br").length ||
            e.querySelector(a.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)") ||
            1 < e.querySelectorAll(w.FE.BLOCK_TAGS.join(",")).length ||
        ...
        deepestParent: function (e, t, n) {
          if (
            ...
            void 0 === n && (n = !0),
            t.push(a.el),
            0 <= t.indexOf(e.parentNode) || (e.parentNode && a.node.hasClass(e.parentNode, "fr-inner")) || (e.parentNode && 0 <= w.FE.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) && n))
          )
            return null;
    ...
    (w.FE.INVISIBLE_SPACE = "&#8203;"),
    (w.FE.START_MARKER = '<span class="fr-marker" data-id="0" data-type="true" style="display: none; line-height: 0;">' + w.FE.INVISIBLE_SPACE + "</span>"),
    (w.FE.END_MARKER = '<span class="fr-marker" data-id="0" data-type="false" style="display: none; line-height: 0;">' + w.FE.INVISIBLE_SPACE + "</span>"),
    (w.FE.MARKERS = w.FE.START_MARKER + w.FE.END_MARKER),
    (w.FE.MODULES.markers = function (d) {
      function l() {
        if (!d.$wp) return null;
        try {
          ...
          if (d.core.isEmpty() && t.textContent !== w("<span>").html(w.FE.INVISIBLE_SPACE).text())
            return (
              ...
              d.$el.find(".fr-marker:first").replaceWith('<span class="fr-single-marker" style="display: none; line-height: 0;">' + w.FE.INVISIBLE_SPACE + "</span>"),
      ...
      return {
        place: function (e, t, n) {
          ...
          try {
            ...
            if (
              (a.collapse(t),
              a.insertNode(w('<span class="fr-marker" data-id="' + n + '" data-type="' + t + '" style="display: ' + (d.browser.safari ? "none" : "inline-block") + '; line-height: 0;">' + w.FE.INVISIBLE_SPACE + "</span>", d.doc)[0]),
              !0 === t)
            )
        ...
        split: function () {
          ...
          if ((t || ((t = d.node.blockParent(e)) && "LI" != t.tagName && (t = null)), t))
            if (d.node.isBlock(t) && d.node.isEmpty(t))
              "LI" != t.tagName || t.parentNode.firstElementChild != t || d.node.isEmpty(t.parentNode) ? w(t).replaceWith('<span class="fr-marker"></span>') : w(t).append('<span class="fr-marker"></span>');
    ...
    (w.FE.MODULES.selection = function (S) {
        ...
        if (S.$wp) {
          ...
          for (t = 0; t < n.length; t++)
            if (n[t].startContainer !== S.doc || S.browser.msie) {
              ...
              if (((void 0 !== i && i) || !o || (w(".fr-marker").remove(), S.selection.setAtEnd(S.el)), S.el.normalize(), S.browser.safari && !o))
                try {
              ...
              if (o.nextSibling == a || a.nextSibling == o) {
                ...
                if ((m && (S.node.isVoid(m) || S.node.isBlock(m)) && (m = null), E && (S.node.isVoid(E) || S.node.isBlock(E)) && (E = null), m && E && m.nodeType == Node.TEXT_NODE && E.nodeType == Node.TEXT_NODE)) {
                  ...
                  !m && E && E.nodeType == Node.TEXT_NODE
                    ? (w(o).remove(), w(a).remove(), S.opts.htmlUntouched || S.spaces.normalize(E), (s = w(S.doc.createTextNode("\u200b"))), w(E).before(s), i.setStart(E, 0), i.setEnd(E, 0), (d = !0))
                    : !E &&
                      m &&
                      m.nodeType == Node.TEXT_NODE &&
                      (w(o).remove(), w(a).remove(), S.opts.htmlUntouched || S.spaces.normalize(m), (s = w(S.doc.createTextNode("\u200b"))), w(m).after(s), i.setStart(m, m.textContent.length), i.setEnd(m, m.textContent.length), (d = !0));
              }
              if (!d)
                (S.browser.chrome || S.browser.edge) && o.nextSibling == a
                  ...
                  : (o.previousSibling == a && (a = (o = a).nextSibling),
                    (a.nextSibling && "BR" === a.nextSibling.tagName) ||
                      ...
                      ((o.style.display = "inline"), (a.style.display = "inline"), (s = w(S.doc.createTextNode("\u200b")))),
                    (f = A(o, i, !0) || (w(o).before(s) && i.setStartBefore(o))),
                    (p = A(a, i, !1) || (w(a).after(s) && i.setEndAfter(a)))),
                  "function" == typeof f && f(),
                  "function" == typeof p && p();
            } catch (b) {}
          }
      ...
      function o(e) {
        ...
        if (S.win.getSelection) {
          ...
          i.rangeCount &&
            ((n = (t = i.getRangeAt(0)).cloneRange()).selectNodeContents(e), n.setEnd(t.startContainer, t.startOffset), (r = "" === n.toString()), n.selectNodeContents(e), n.setStart(t.endContainer, t.endOffset), (o = "" === n.toString()));
        } else
          S.doc.selection &&
      ...
      return {
          ...
          try {
            if (e.rangeCount) {
              ...
              if (r.nodeType == Node.ELEMENT_NODE) {
                var o = !1;
                0 < r.childNodes.length && r.childNodes[n.endOffset] && w(r.childNodes[n.endOffset]).text() === s()
                  ...
                  : !n.collapsed &&
                    ...
                    ((r = t), (o = !0)),
                  !o && 0 < r.childNodes.length && w(r.childNodes[r.childNodes.length - 1]).text() === s() && ["BR", "IMG", "HR"].indexOf(r.childNodes[r.childNodes.length - 1].tagName) < 0 && (r = r.childNodes[r.childNodes.length - 1]);
              }
        ...
        remove: function () {
          ...
          for (t = 0; t < o.length; t++) for (var i = o[t]; !(n(i) || S.node.isBlock(i.parentNode) || S.$el.is(i.parentNode) || S.node.hasClass(i.parentNode, "fr-inner")); ) w(i.parentNode).before(i);
          ...
          if (
            (function () {
              for (var e = S.$el.find(".fr-marker"), t = 0; t < e.length; t++) if (w(e[t]).parentsUntil('.fr-element, [contenteditable="true"]', '[contenteditable="false"]').length) return !1;
              return !0;
            })()
          ) {
            !(function e(t, n) {
              ...
              for (var o = 0; o < r.length; o++) {
                ...
                S.node.hasClass(i, "fr-marker")
                  ...
                  ? 0 < w(i).find(".fr-marker").length
                    ...
                    ? 0 === w(i).find(".fr-inner").length
                      ? w(i).html("<br>")
                      : w(i).find(".fr-inner").filter(O).html("<br>")
                    : (w(i).empty(), w(i).attr("data-del-cell", !0))
                  : 0 < w(i).find(".fr-marker").length && (n = e(w(i), n));
              }
              return n;
            })(S.$el, 0);
                ...
                if (f) {
                  if (d && (!c || c != f)) {
                    ...
                    if ((p && 0 <= ["UL", "OL"].indexOf(p.tagName) && (g = !(p = null)), u && 0 <= ["UL", "OL"].indexOf(u.tagName) && (h = !(u = null)), w(d).after(f), p != u))
                      if (null != p || g)
                        if (null != u || h || 0 !== w(p).parentsUntil(S.$el, "table").length)
                          p && u && 0 === w(p).parentsUntil(S.$el, "table").length && 0 === w(u).parentsUntil(S.$el, "table").length && 0 === w(p).find(u).length && 0 === w(u).find(p).length && (w(p).append(w(u).html()), w(u).remove());
                        else {
    ...
    (w.FE.HTML5Map = { B: "STRONG", I: "EM", STRIKE: "S" }),
    (w.FE.MODULES.clean = function (f) {
        ...
        var i = (function (e, t, n) {
          if (f.opts.fullPage) {
            ...
            return (
              ...
              r + "<html" + o + "><head" + l(f.html.extractNodeAttrs(n, "head")) + ">" + t + "</head><body" + l(f.html.extractNodeAttrs(n, "body")) + ">" + e + "</body></html>"
            );
          }
          return e;
        })(r, o, e);
        ...
        !(function (e) {
          ...
          if (
            ...
            e.nodeType == Node.ELEMENT_NODE &&
              (e.getAttribute("data-fr-src") && 0 !== e.getAttribute("data-fr-src").indexOf("blob:") && e.setAttribute("data-fr-src", f.helpers.sanitizeURL(E(e.getAttribute("data-fr-src")))),
              e.getAttribute("href") && e.setAttribute("href", f.helpers.sanitizeURL(E(e.getAttribute("href")))),
              e.getAttribute("src") && e.setAttribute("src", f.helpers.sanitizeURL(E(e.getAttribute("src")))),
              e.getAttribute("data") && e.setAttribute("data", f.helpers.sanitizeURL(E(e.getAttribute("data")))),
              0 <= ["TABLE", "TBODY", "TFOOT", "TR"].indexOf(e.tagName) && (e.innerHTML = e.innerHTML.trim())),
            !f.opts.pasteAllowLocalImages && e.nodeType == Node.ELEMENT_NODE && "IMG" == e.tagName && e.getAttribute("data-fr-src") && 0 === e.getAttribute("data-fr-src").indexOf("file://"))
          )
          ...
          if (f.opts.htmlAllowComments || e.nodeType != Node.COMMENT_NODE)
            if (e.tagName && e.tagName.match(u)) e.parentNode.removeChild(e);
              ...
              else if (!f.browser.safari || "path" != e.tagName || !e.parentNode || "svg" != e.parentNode.tagName)
                try {
      ...
      return {
        ...
        html: function (e, t, n, r) {
          ...
          var o,
            i = w.merge([], f.opts.htmlAllowedTags);
          ...
          return (
            a.push("data-fr-.*"),
            a.push("fr-.*"),
            (p = new RegExp("^" + i.join("$|^") + "$", "gi")),
            (g = new RegExp("^" + a.join("$|^") + "$", "gi")),
            (u = new RegExp("^" + f.opts.htmlRemoveTags.join("$|^") + "$", "gi")),
            (h = f.opts.htmlAllowedStyleProps.length ? new RegExp("((^|;|\\s)" + f.opts.htmlAllowedStyleProps.join(":.+?(?=;|$))|((^|;|\\s)") + ":.+?(?=(;)|$))", "gi") : null),
            (e = c(e, v, !0))
          );
        },
        toHTML5: function () {
    ...
    (w.FE.MODULES.spaces = function (l) {
      function r(e, t) {
        ...
        if (!l.html.isPreformatted(i)) {
          t &&
            ((o = o.replace(/[\f\n\r\t\v ]{2,}/g, " ")),
            (r && "BR" !== r.tagName && !l.node.isBlock(r)) || !(l.node.isBlock(i) || (l.node.isLink(i) && !i.nextSibling) || l.node.isElement(i)) || (o = o.replace(/[\f\n\r\t\v ]{1,}$/g, "")),
            (n && "BR" !== n.tagName && !l.node.isBlock(n)) || !(l.node.isBlock(i) || (l.node.isLink(i) && !i.previousSibling) || l.node.isElement(i)) || (o = o.replace(/^[\f\n\r\t\v ]{1,}/g, "")),
            (l.node.isBlock(r) || l.node.isBlock(n)) && (o = o.replace(/^[\f\n\r\t\v ]{1,}/g, "")),
            " " === o && ((n && l.node.isVoid(n)) || (r && l.node.isVoid(r))) && !((n && r && l.node.isVoid(n)) || (r && n && l.node.isVoid(r))) && (o = "")),
            ((!n && l.node.isBlock(r)) || (!r && l.node.isBlock(n))) && l.node.isBlock(i) && i !== l.el && (o = o.replace(/^[\f\n\r\t\v ]{1,}/g, "")),
            t || (o = o.replace(new RegExp(w.FE.UNICODE_NBSP, "g"), " "));
          ...
          (!r || (r && l.node.isBlock(r)) || (r && r.nodeType == Node.ELEMENT_NODE && l.win.getComputedStyle(r) && "block" == l.win.getComputedStyle(r).display)) && (l.node.isVoid(n) || (a = a.replace(/ $/, w.FE.UNICODE_NBSP))),
            !n ||
              l.node.isVoid(n) ||
              l.node.isBlock(n) ||
              1 !== (a = a.replace(/^\u00A0([^ $])/, " $1")).length ||
              160 !== a.charCodeAt(0) ||
              !r ||
              l.node.isVoid(r) ||
              l.node.isBlock(r) ||
              (l.node.hasClass(n, "fr-marker") && l.node.hasClass(r, "fr-marker")) ||
              (a = " "),
            t || (a = a.replace(/([^ \u00A0])\u00A0([^ \u00A0])/g, "$1 $2")),
    ...
    (w.FE.UNICODE_NBSP = String.fromCharCode(160)),
    (w.FE.VOID_ELEMENTS = ["area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr"]),
    (w.FE.BLOCK_TAGS = [
      "address",
      "article",
      "aside",
      ...
      function d(e) {
        ...
        if (t && (F.node.isBlock(t) || F.node.isElement(t)) && ["TD", "TH"].indexOf(t.tagName) < 0) {
          ...
          n &&
            ...
            ((F.el == t && !r && F.opts.enter == w.FE.ENTER_BR && F.browser.msie) || e.parentNode.removeChild(e));
        ...
        F.node.isEmpty(F.el) &&
          (null != c()
            ? F.el.querySelector(p()) ||
              ...
              (F.core.hasFocus() ? (F.$el.html("<" + c() + ">" + w.FE.MARKERS + "<br/></" + c() + ">"), F.selection.restore()) : F.$el.html("<" + c() + "><br/></" + c() + ">"))
            : F.el.querySelector("*:not(.fr-marker):not(br)") || (F.core.hasFocus() ? (F.$el.html(w.FE.MARKERS + "<br/>"), F.selection.restore()) : F.$el.html("<br/>")));
      }
      function g(e, t) {
      ...
      return {
        ...
        fillEmptyBlocks: function (e) {
          ...
          for (var n = 0; n < t.length; n++) {
            ...
            "false" === r.getAttribute("contenteditable") ||
              ...
              F.node.isVoid(r) ||
              ("TABLE" != r.tagName && "TBODY" != r.tagName && "TR" != r.tagName && "UL" != r.tagName && "OL" != r.tagName && r.appendChild(F.doc.createElement("br")));
          }
          ...
          if (F.opts.fullPage) {
            ...
            E(F.$el, d + "\n" + i),
              ...
              F.iframe_document.doctype.parentNode.replaceChild(
                ((t = c), (n = F.iframe_document), (r = t.match(/<!DOCTYPE ?([^ ]*) ?([^ ]*) ?"?([^"]*)"? ?"?([^"]*)"?>/i)) ? n.implementation.createDocumentType(r[1], r[3], r[4]) : n.implementation.createDocumentType("html")),
          ...
          var e,
            ...
            n = function (e, t) {
              for (; t && (t.nodeType == Node.TEXT_NODE || !F.node.isBlock(t)) && !F.node.isElement(t) && !F.node.hasClass(t, "fr-inner"); )
                t && t.nodeType != Node.TEXT_NODE && w(e).wrapInner(F.node.openTagString(t) + F.node.closeTagString(t)), (t = t.parentNode);
            ...
            for (var o = F.selection.ranges(), i = 0; i < o.length; i++) {
              ...
              a.appendChild(o[i].cloneContents()),
                n(
                  ...
                  null != t && (0 <= w.inArray(F.el, w(t).parents()) || t == F.el) ? t : null)
                ),
                0 < w(a).find(".fr-element").length && (a = F.el),
                (r += a.innerHTML);
            }
        ...
        unwrap: function () {
          F.$el.find("div.fr-temp-div").each(function () {
            this.previousSibling && this.previousSibling.nodeType === Node.TEXT_NODE && w(this).before("<br>"),
              w(this).attr("data-empty") || !this.nextSibling || (F.node.isBlock(this.nextSibling) && !w(this.nextSibling).hasClass("fr-temp-div")) ? w(this).replaceWith(w(this).html()) : w(this).replaceWith(w(this).html() + "<br>");
          }),
            F.$el
              .find(".fr-temp-div")
    ...
    w.extend(w.FE.DEFAULTS, { height: null, heightMax: null, heightMin: null, width: null }),
    ...
    w.extend(w.FE.DEFAULTS, { language: null }),
    (w.FE.LANGUAGE = {}),
    (w.FE.MODULES.language = function (e) {
      var t;
      return {
        _init: function () {
    ...
    w.extend(w.FE.DEFAULTS, { placeholderText: "Type something" }),
      ...
      function e() {
        ...
        if (s.length && s[0].nodeType == Node.ELEMENT_NODE) {
          ...
          (!f.opts.toolbarInline || 0 < f.$el.prev().length) &&
            f.ready &&
            ((t = f.helpers.getPX(d.css("margin-top"))),
            (o = f.helpers.getPX(d.css("padding-top"))),
            (n = f.helpers.getPX(d.css("margin-left"))),
            (r = f.helpers.getPX(d.css("margin-right"))),
            (i = f.helpers.getPX(d.css("padding-left"))),
            (a = f.helpers.getPX(d.css("padding-right")))),
            f.$placeholder.css("font-size", d.css("font-size")),
            f.$placeholder.css("line-height", d.css("line-height"));
    ...
    (w.FE.MODULES.core = function (d) {
      ...
      return {
        _init: function () {
          if ((w.FE.INSTANCES.push(d), (d.drag_support = { filereader: "undefined" != typeof FileReader, formdata: !!d.win.FormData, progress: "upload" in new XMLHttpRequest() }), d.$wp)) {
            t(),
      ...
      return {
        _startEnter: function (e) {
          ...
          if (h.node.isEmpty(n, !0) && r) {
            ...
            var d = "";
            for (
              d = l.parentNode && "LI" == l.parentNode.tagName ? s + "<li>" + w.FE.MARKERS + "<br>" + a : i ? s + "<" + i + ">" + w.FE.MARKERS + "<br></" + i + ">" + a : s + w.FE.MARKERS + "<br>" + a;
            ...
            (t = E(n)).parentNode && "LI" == t.parentNode.tagName
              ? r
                ? w(t.parentNode).before(h.node.openTagString(n) + w.FE.MARKERS + "<br></li>")
                : w(t.parentNode).after(h.node.openTagString(n) + w.FE.MARKERS + "<br></li>")
              : i
              ? w(t).before("<" + i + ">" + w.FE.MARKERS + "<br></" + i + ">")
              : w(t).before(w.FE.MARKERS + "<br>"),
              w(n).remove();
        },
        _middleEnter: function (e) {
          for (var t = m(e), n = "", r = e, o = "", i = "", a = !1; r != t; ) {
            var s = "A" == (r = r.parentNode).tagName && h.cursor.isAtEnd(e, r) ? "fr-to-remove" : "";
            a || r == t || h.node.isBlock(r) || ((a = !0), (o += w.FE.INVISIBLE_SPACE)), (o = h.node.openTagString(w(r).clone().addClass(s).get(0)) + o), (i = h.node.closeTagString(r) + i);
          }
          (n = i + n + o + w.FE.MARKERS + (h.opts.keepFormatOnDelete ? w.FE.INVISIBLE_SPACE : "")), w(e).replaceWith('<span id="fr-break"></span>');
          var l = h.node.openTagString(t) + w(t).html() + h.node.closeTagString(t);
          (l = l.replace(/<span id="fr-break"><\/span>/g, n)), w(t).replaceWith(l);
        },
        ...
        _backspace: function (e) {
          ...
          if (n) {
            ...
            r.length && "BR" == r[r.length - 1].tagName && w(r[r.length - 1]).remove(),
              w(t)
        ...
        _del: function (e) {
          var t,
            ...
            r = n.nextSibling;
          if (r) {
            (t = h.node.contents(r)).length && "BR" == t[0].tagName && w(t[0]).remove(),
              w(r)
                .find(h.html.blockTagsQuery())
                .not("ol, ul, table")
                .each(function () {
            ...
            if (s == h.el) return !1;
            if (((s = s.nextSibling), h.node.isBlock(s)))
              w.FE.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (w(e).replaceWith(w.FE.MARKERS), (t = h.node.contents(n)).length && "BR" == t[t.length - 1].tagName && w(t[t.length - 1]).remove(), w(n).append(w(s).html()), w(s).remove());
            else for ((t = h.node.contents(n)).length && "BR" == t[t.length - 1].tagName && w(t[t.length - 1]).remove(), w(e).replaceWith(w.FE.MARKERS); s && !h.node.isBlock(s) && "BR" != s.tagName; ) w(n).append(w(s)), (s = s.nextSibling);
          }
        },
      };
    }),
    (w.FE.NO_DELETE_TAGS = ["TH", "TD", "TR", "TABLE", "FORM"]),
    (w.FE.SIMPLE_ENTER_TAGS = ["TH", "TD", "LI", "DL", "DT", "FORM"]),
    (w.FE.MODULES.cursor = function (u) {
      function i(e) {
        return (
          !!e &&
          (!!u.node.isBlock(e) ||
      ...
      function g(e, t) {
        return (
          !!e &&
          e != u.$wp.get(0) &&
          (e.previousSibling && e.previousSibling.nodeType == Node.TEXT_NODE && 0 === e.previousSibling.textContent.replace(/\u200b/g, "").length ? g(e.previousSibling, t) : !e.previousSibling && (e.parentNode == t || g(e.parentNode, t)))
        );
      }
      function h(e, t) {
        return (
        ...
        if (((n = n.previousSibling), !u.node.isBlock(n) && u.node.isEditable(n))) {
          ...
          if (n.nodeType == Node.TEXT_NODE) {
            ...
            if (u.opts.tabSpaces && r.length >= u.opts.tabSpaces)
              0 ===
                r
                  ...
                  .replace(/ /g, "")
                  .replace(new RegExp(w.FE.UNICODE_NBSP, "g"), "").length && (o = r.length - u.opts.tabSpaces + 1);
            (n.textContent = r.substring(0, o - d(r))),
              u.opts.htmlUntouched && !e.nextSibling && n.textContent.length && " " === n.textContent[n.textContent.length - 1] && (n.textContent = n.textContent.substring(0, n.textContent.length - 1) + w.FE.UNICODE_NBSP);
            ...
            u.node.isDeletable(n)
              ? (w(n).after(w.FE.MARKERS), w(n).remove())
              : e.nextSibling && "BR" == e.nextSibling.tagName && u.node.isVoid(n) && "BR" != n.tagName
              ? (w(e.nextSibling).remove(), w(e).replaceWith(w.FE.MARKERS))
              : !1 !== u.events.trigger("node.remove", [w(n)]) && (w(n).after(w.FE.MARKERS), w(n).remove());
          ...
          if (u.node.isDeletable(n)) w(e).replaceWith(w.FE.MARKERS), w(n).remove();
            ...
            for (u.node.isList(n) && (n = w(n).find("li:last").get(0)), (t = u.node.contents(n)) && "BR" == t[t.length - 1].tagName && w(t[t.length - 1]).remove(), t = u.node.contents(n); t && u.node.isBlock(t[t.length - 1]); )
                ...
                if (u.node.isEmpty(n, !0)) w(n).remove(), w(i).find("li:first").prepend(w.FE.MARKERS);
                  ...
                  "BLOCKQUOTE" == n.tagName && (o = u.node.contents(n)).length && u.node.isBlock(o[o.length - 1]) && (n = o[o.length - 1]),
                    0 === a.find("ul, ol").length &&
                      ...
                      w(n).append(u.node.contents(a.get(0))),
                      a.remove(),
                      0 === w(i).find("li").length && w(i).remove());
                }
              else {
      ...
      function n(e) {
        ...
        if (!u.node.isBlock(n) && u.node.isEditable(n)) {
          ...
          n.nodeType == Node.TEXT_NODE
            ? (w(n).before(w.FE.MARKERS), n.textContent.length && (n.textContent = n.textContent.substring(d(n.textContent, !0), n.textContent.length)))
            : u.node.isDeletable(n)
            ? (w(n).before(w.FE.MARKERS), w(n).remove())
            : !1 !== u.events.trigger("node.remove", [w(n)]) && (w(n).before(w.FE.MARKERS), w(n).remove()),
            w(e).remove();
        } else if (w.FE.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n)))
          if (u.node.isDeletable(n)) w(e).replaceWith(w.FE.MARKERS), w(n).remove();
      ...
      function p(e, t, n) {
        ...
        if (o && "BLOCKQUOTE" == o.tagName)
          return h(e, o) ? ((r = u.html.defaultTag()), t ? w(e).replaceWith("<br>" + w.FE.MARKERS) : r ? w(o).after("<" + r + ">" + w.FE.MARKERS + "<br></" + r + ">") : w(o).after(w.FE.MARKERS + "<br>"), w(e).remove()) : m(e, t, n), !1;
        if (null == o)
          (r = u.html.defaultTag()) && u.node.isElement(e.parentNode)
            ? w(e).replaceWith("<" + r + ">" + w.FE.MARKERS + "<br></" + r + ">")
            : !e.previousSibling || w(e.previousSibling).is("br") || e.nextSibling
            ? w(e).replaceWith("<br>" + w.FE.MARKERS)
            : w(e).replaceWith("<br>" + w.FE.MARKERS + "<br>");
        else {
          var i = e,
            a = "";
          ...
          do {
            if (((i = i.parentNode), !t || i != o || (t && !u.node.isBlock(o))))
              if (((l += u.node.closeTagString(i)), i == o && u.node.isBlock(o))) d = c + d;
                ...
                var p = ("A" == i.tagName || w(i).hasClass("fa")) && h(e, i) ? "fr-to-remove" : "";
                d = u.node.openTagString(w(i).clone().addClass(p).get(0)) + d;
              }
          } while (i != o);
          (a = l + a + d + (e.parentNode == o && u.node.isBlock(o) ? "" : w.FE.INVISIBLE_SPACE) + w.FE.MARKERS),
            u.node.isBlock(o) && !w(o).find("*:last").is("br") && w(o).append("<br/>"),
            w(e).after('<span id="fr-break"></span>'),
            w(e).remove(),
            (o.nextSibling && !u.node.isBlock(o.nextSibling)) || u.node.isBlock(o) || w(o).after("<br>"),
            (s = (s = !t && u.node.isBlock(o) ? u.node.openTagString(o) + w(o).html() + f : u.node.openTagString(o) + w(o).html() + u.node.closeTagString(o)).replace(/<span id="fr-break"><\/span>/g, a)),
            w(o).replaceWith(s);
        }
      }
      function m(e, t, n) {
        ...
        if (null == r)
          u.html.defaultTag() && e.parentNode === u.el
            ? w(e).replaceWith("<" + u.html.defaultTag() + ">" + w.FE.MARKERS + "<br></" + u.html.defaultTag() + ">")
            : ((e.nextSibling && !u.node.isBlock(e.nextSibling)) || w(e).after("<br>"), w(e).replaceWith("<br>" + w.FE.MARKERS));
        else if ((e.previousSibling && "IMG" == e.previousSibling.tagName) || (e.nextSibling && "IMG" == e.nextSibling.tagName)) w(e).replaceWith("<" + u.html.defaultTag() + ">" + w.FE.MARKERS + "<br></" + u.html.defaultTag() + ">");
        else {
          var o = e,
            i = "";
          ...
          do {
            ...
            if (((o = o.parentNode), "BLOCKQUOTE" == r.tagName && u.node.isEmpty(l) && !u.node.hasClass(l, "fr-marker") && 0 < w(l).find(e).length && w(l).after(e), "BLOCKQUOTE" != r.tagName || (!h(e, o) && !g(e, o))))
              if (!t || o != r || (t && !u.node.isBlock(r))) {
                ...
                var d = ("A" == o.tagName && h(e, o)) || w(o).hasClass("fa") ? "fr-to-remove" : "";
          ...
          if ("BLOCKQUOTE" == r.tagName)
            if ((e.previousSibling && u.node.isBlock(e.previousSibling) && e.nextSibling && "BR" == e.nextSibling.tagName && (w(e.nextSibling).after(e), e.nextSibling && "BR" == e.nextSibling.tagName && w(e.nextSibling).remove()), t))
              i = a + i + w.FE.MARKERS + s;
            else {
      ...
      return {
        enter: function (t) {
          ...
          u.el.normalize();
          var o = !1;
          0 < w(n).parentsUntil(u.$el, "BLOCKQUOTE").length && (o = !0),
            w(n).parentsUntil(u.$el, "TD, TH").length && (o = !1),
            i(n)
              ? !s(n) || t || o
                ? p(n, t, o)
                      ...
                      if (u.node.isBlock(i))
                        if (("PRE" == i.tagName && (n = !0), n)) w(t).remove(), w(i).prepend("<br>" + w.FE.MARKERS);
                          ...
                          if ((t.nextSibling && "IMG" == t.nextSibling.tagName) || (t.nextSibling && t.nextSibling.nextElementSibling && "IMG" == t.nextSibling.nextElementSibling))
                            w(t).replaceWith("<" + u.html.defaultTag() + ">" + w.FE.MARKERS + "<br></" + u.html.defaultTag() + ">");
        ...
        backspace: function () {
          ...
          return (
            i(t)
              ? s(t) && g(t, w(t).parents("li:first").get(0))
              ...
              ? s(t) && g(t, w(t).parents("li:first").get(0))
                ...
                : (function (e) {
                    for (
                      var t = 0 < w(e).parentsUntil(u.$el, "BLOCKQUOTE").length, n = u.node.deepestParent(e, [], !t), r = n;
                      n && !n.previousSibling && "BLOCKQUOTE" != n.tagName && n.parentElement != u.el && !u.node.hasClass(n.parentElement, "fr-inner") && w.FE.SIMPLE_ENTER_TAGS.indexOf(n.parentElement.tagName) < 0;
                          ...
                          if (u.node.isDeletable(a)) w(a).remove(), w(e).replaceWith(w.FE.MARKERS);
                            ...
                            if (u.node.isBlock(a))
                              if (u.node.isEmpty(a) && !u.node.isList(a)) w(a).remove(), w(e).after(u.opts.keepFormatOnDelete ? w.FE.INVISIBLE_SPACE : "");
                                ...
                                if (
                                  (u.node.isList(a) && (a = w(a).find("li:last").get(0)),
                                  (i = u.node.contents(a)).length && "BR" == i[i.length - 1].tagName && w(i[i.length - 1]).remove(),
                              ...
                              w(e).replaceWith(w.FE.MARKERS),
                                "BLOCKQUOTE" == n.tagName && a.nodeType == Node.ELEMENT_NODE ? w(a).remove() : (w(a).after(u.node.isEmpty(n) ? "" : w(n).html()), w(n).remove(), "BR" == a.tagName && w(a).remove());
                        } else
                          a ||
                            (n &&
                            ...
                            0 ===
                              w(n)
                                ...
                                .replace(/\u200B/g, "").length
                              ? w(n).remove()
                              : u.node.isEmpty(n) && n.parentNode && u.node.isEditable(n.parentNode) && n.parentNode != u.el && w(n.parentNode).remove());
                    }
                  })(t)
              : (e = c(t)),
            w(t).remove(),
    ...
    w.extend(w.FE.DEFAULTS, { enter: w.FE.ENTER_P, multiLine: !0, tabSpaces: 0 }),
    (w.FE.MODULES.keys = function (l) {
      ...
      function a(e) {
        ...
        if (
          ((!(g(e) || (e.shiftKey && (33 === n || 34 === n || 35 === n || 36 === n))) && l.selection.isFull() && !l.opts.keepFormatOnDelete && !l.placeholder.isVisible()) || (s && l.placeholder.isVisible() && l.opts.keepFormatOnDelete)) &&
          (a || s) &&
          (f(), !m(n))
        )
          return e.preventDefault(), !0;
        n == w.FE.KEYCODE.ENTER
          ? e.shiftKey
          ...
          : n === w.FE.KEYCODE.BACKSPACE && (e.metaKey || e.ctrlKey)
          ? setTimeout(function () {
              l.events.disableBlur(), l.events.focus();
            }, 0)
          : n != w.FE.KEYCODE.BACKSPACE || g(e) || e.altKey
          ? n != w.FE.KEYCODE.DELETE || g(e) || e.altKey || e.shiftKey
            ? n == w.FE.KEYCODE.SPACE
              ? (function (e) {
                  var t = l.selection.element();
                  if (!l.helpers.isMobile() && t && "A" == t.tagName) {
                    ...
                    if (n) {
                      ...
                      !n.nextSibling && n.parentNode && "A" == n.parentNode.tagName
                        ? (n.parentNode.insertAdjacentHTML("afterend", "&nbsp;" + w.FE.MARKERS), n.parentNode.removeChild(n))
      ...
      function s() {
        ...
        l.opts.height || l.opts.heightMax
          ...
          : ((e = l.position.getBoundingRect().top),
            ...
            l.opts.iframe && ((e += l.$iframe.offset().top), (e -= l.helpers.scrollTop())),
            (e += l.opts.toolbarStickyOffset) > l.o_win.innerHeight - 20 && w(l.o_win).scrollTop(e + l.helpers.scrollTop() - l.o_win.innerHeight + 20),
            (e = l.position.getBoundingRect().top),
            l.opts.toolbarBottom || (e -= l.opts.toolbarStickyOffset),
            l.opts.iframe && ((e += l.$iframe.offset().top), (e -= l.helpers.scrollTop())),
            e < l.$tb.height() + 20 && w(l.o_win).scrollTop(e + l.helpers.scrollTop() - l.$tb.height() - 20));
      }
      function p() {
        var e,
      ...
      function u(e) {
        ...
        if (e && !l.helpers.isIOS() && (e.which == w.FE.KEYCODE.ENTER || e.which == w.FE.KEYCODE.BACKSPACE || (37 <= e.which && e.which <= 40 && !l.browser.msie)))
          try {
            s();
          } catch (n) {}
        p();
      ...
      function b(e) {
        ...
        try {
          return (
            (0 === (e.textContent || "").length && e.querySelector && !e.querySelector(":scope > br")) ||
      ...
      function S(e) {
        ...
        return (
          !l.node.isEditable(e.target) || (r && "false" == w(r).attr("contenteditable")) ? l.toolbar.disable() : l.toolbar.enable(),
          !(!e.target || e.target === l.el) ||
            0 === t.length ||
            void (t[0].offsetHeight + t[0].offsetTop <= e.offsetY
              ? b(t[t.length - 1]) && (n ? l.$el.append("<" + n + ">" + w.FE.MARKERS + "<br></" + n + ">") : l.$el.append(w.FE.MARKERS + "<br>"), l.selection.restore(), s())
              : e.offsetY <= 10 && b(t[0]) && (n ? l.$el.prepend("<" + n + ">" + w.FE.MARKERS + "<br></" + n + ">") : l.$el.prepend(w.FE.MARKERS + "<br>"), l.selection.restore(), s()))
        );
      }
      function T() {
        n && clearTimeout(n);
      ...
      function h(e) {
        if (f.shared.$f_el) {
          ...
          if (f.shared.$f_el.is("a.fr-command"))
            return (
              (t = e ? f.shared.$f_el.closest("li").nextAll(":visible:first").find(".fr-command:not(.fr-disabled)").first() : f.shared.$f_el.closest("li").prevAll(":visible:first").find(".fr-command:not(.fr-disabled)").first()).length ||
      ...
      return {
              ...
              (c = f.popups.get(d)),
              {
                _tiKeydown: function (e) {
                  ...
                  if (w.FE.KEYCODE.TAB == n) {
                    ...
                    if (w.FE.KEYCODE.ENTER != n || !e.target || "TEXTAREA" === e.target.tagName)
                      return w.FE.KEYCODE.ESC == n
                        ? (e.preventDefault(),
                          e.stopPropagation(),
                          ...
                          !1)
                        : w.FE.KEYCODE.SPACE == n && (r.is(".fr-submit") || r.is(".fr-dismiss"))
                        ...
                        ? void e.stopPropagation()
                        : w.FE.KEYCODE.SPACE == n && (r.is(".fr-link-attr") || r.is("input[type=file]"))
                        ? void e.stopPropagation()
        ...
        exec: function (e, t) {
          var n = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey,
            ...
            o = !1;
          return (
            r != w.FE.KEYCODE.TAB || n || e.shiftKey || e.altKey
              ? r != w.FE.KEYCODE.ARROW_RIGHT || n || e.shiftKey || e.altKey
                ? r != w.FE.KEYCODE.TAB || n || !e.shiftKey || e.altKey
                  ? r != w.FE.KEYCODE.ARROW_LEFT || n || e.shiftKey || e.altKey
                    ? r != w.FE.KEYCODE.ARROW_UP || n || e.shiftKey || e.altKey
                      ? r != w.FE.KEYCODE.ARROW_DOWN || n || e.shiftKey || e.altKey
                        ? (r != w.FE.KEYCODE.ENTER && r != w.FE.KEYCODE.SPACE) || n || e.shiftKey || e.altKey
                          ? r != w.FE.KEYCODE.ESC || n || e.shiftKey || e.altKey
                            ? r != w.FE.KEYCODE.F10 || n || e.shiftKey || !e.altKey || (o = l())
                            : (o = (function (e) {
                                if (f.shared.$f_el) {
                                  var t = d();
                                  return (
                                    t
                                      ...
                                      ? ((f.shared.with_kb = !1), f.opts.toolbarInline && (f.events.disableBlur(), f.events.focus()), f.button.exec(e.parent().find(".fr-back:visible:first")), v(e.parent()))
    ...
    (w.FE.MODULES.format = function (h) {
      ...
      function m(e, t, n) {
        if (e) {
          ...
          if (e) {
            if (h.node.isBlock(e) && "HR" !== e.tagName) return h.node.hasClass(e.firstChild, "fr-marker") ? m(e.firstChild.nextSibling, t, n) : m(e.firstChild, t, n), !1;
            ...
            if (o)
              w(o).find(".fr-marker").length || "UL" == o.tagName || "OL" == o.tagName
                ? m(o.firstChild, t, n)
                : h.browser.mozilla && h.node.hasClass(o, "fr-marker") && o.parentNode.nextSibling && m(o.parentNode.nextSibling.nextSibling, t, n);
            else {
      ...
      function r(t, n) {
        ...
        !(function e(t, n, r, o) {
            ...
            if (h.node.hasClass(s, "fr-marker")) n = (n + 1) % 2;
              ...
              if (0 < w(s).find(".fr-marker").length) n = e(w(s), n, r, o);
                ...
                for (var l = w(s).find(r || "*:not(br)"), d = l.length - 1; 0 <= d; d--) {
                  var c = l[d];
                  h.node.isBlock(c) || h.node.isVoid(c) || (void 0 !== r && !p(c, f(r, o)))
                    ? h.node.isBlock(c) && void 0 === r && "TABLE" != s.tagName && h.node.clearAttributes(c)
                    : h.node.hasClass(c, "fr-clone") || (c.outerHTML = c.innerHTML);
                }
                (void 0 === r && s.nodeType == Node.ELEMENT_NODE && !h.node.isVoid(s)) || p(s, f(r, o))
                  ? h.node.isBlock(s)
                    ? void 0 === r && s.nodeType == Node.ELEMENT_NODE && h.node.isBlock(s) && "TABLE" != s.tagName && h.node.clearAttributes(s)
                    : h.node.hasClass(s, "fr-clone") || (s.outerHTML = s.innerHTML)
                  : void 0 === r && s.nodeType == Node.ELEMENT_NODE && h.node.isBlock(s) && "TABLE" != s.tagName && h.node.clearAttributes(s);
              }
          ...
          r && h.$el.find(".fr-marker").before(w.FE.INVISIBLE_SPACE).after(w.FE.INVISIBLE_SPACE),
      ...
      function t(e, t) {
        ...
        if (h.selection.isCollapsed()) {
          ...
          if (h.node.openTagString(l.get(0)) == '<span style="' + e + ": " + l.css(e) + ';">') {
            if (h.node.isEmpty(l.get(0))) (s = w('<span style="' + e + ": " + t + ';">' + w.FE.INVISIBLE_SPACE + w.FE.MARKERS + "</span>")), l.replaceWith(s);
              ...
              (d["style*"] = e + ":"),
                ...
                t ? ((s = w('<span style="' + e + ": " + t + ';">' + w.FE.INVISIBLE_SPACE + w.FE.MARKERS + "</span>")), r.replaceWith(s)) : r.replaceWith(w.FE.INVISIBLE_SPACE + w.FE.MARKERS);
            }
            h.html.cleanEmptyTags();
          ...
          if ((h.selection.save(), null == t || ("color" == e && 0 < h.$el.find(".fr-marker").parents("u, a").length))) {
            ...
            for (n = 0; n < c.length; n++)
              if (!0 === (r = w(c[n])).data("type")) for (; h.node.isFirstSibling(r.get(0)) && !r.parent().is(h.$el) && !h.node.isElement(r.parent().get(0)) && !h.node.isBlock(r.parent().get(0)); ) r.parent().before(r);
          ...
          for (
            t && (p.style = e + ": " + t + ";"),
              m(f, "span", p),
              h.$el.find(".fr-marker + .fr-unprocessed").each(function () {
                w(this).prepend(w(this).prev());
              }),
              h.$el.find(".fr-unprocessed + .fr-marker").each(function () {
                w(this).prev().append(this);
              }),
              (t || "").match(/\dem$/) && h.$el.find("span.fr-unprocessed").removeClass("fr-unprocessed");
            0 < h.$el.find("span.fr-unprocessed").length;
        ...
        !(function () {
          ...
          h.$el.find(".fr-split").removeClass("fr-split"),
            ...
            h.html.cleanEmptyTags(),
            w(h.$el.find("span").get().reverse()).each(function () {
      ...
      function v(e, t, n) {
        ...
        if ((a = a.not(s)).length) {
          for (
            ...
            (p = p.parentNode),
              w(p).addClass("fr-split"),
              (l += h.node.closeTagString(p)),
              (d = h.node.openTagString(w(p).clone().addClass("fr-split").get(0)) + d),
              a.get(0) != p && ((c += h.node.closeTagString(p)), (f = h.node.openTagString(w(p).clone().addClass("fr-split").get(0)) + f)),
              a.get(0) != p;
    ...
    w.extend(w.FE.DEFAULTS, { indentMargin: 20 }),
    (w.FE.COMMANDS = {
      bold: {
        title: "Bold",
        toggle: !0,
      ...
      var i = {
        ...
        insertHR: function () {
          ...
          n.prev().is("hr") ? (t = a.selection.setAfter(n.get(0), !1)) : n.next().is("hr") ? (t = a.selection.setBefore(n.get(0), !1)) : a.selection.setAfter(n.get(0), !1) || a.selection.setBefore(n.get(0), !1),
            t || void 0 === t || ((e = o((e = w.FE.MARKERS + "<br>"))), n.after(e)),
            a.selection.restore();
        },
      ...
      function t(e, t) {
        if (!1 !== a.events.trigger("commands.before", w.merge([e], t || []))) {
          var n = (w.FE.COMMANDS[e] && w.FE.COMMANDS[e].callback) || i[e],
            r = !0,
            o = !1;
          w.FE.COMMANDS[e] && ("undefined" != typeof w.FE.COMMANDS[e].focus && (r = w.FE.COMMANDS[e].focus), "undefined" != typeof w.FE.COMMANDS[e].accessibilityFocus && (o = w.FE.COMMANDS[e].accessibilityFocus)),
            ((!a.core.hasFocus() && r && !a.popups.areVisible()) || (!a.core.hasFocus() && o && a.accessibility.hasFocus())) && a.events.focus(!0),
            w.FE.COMMANDS[e] && !1 !== w.FE.COMMANDS[e].undo && (a.$el.find(".fr-marker").length && (a.events.disableBlur(), a.selection.restore()), a.undo.saveStep()),
            n && n.apply(a, w.merge([e], t || [])),
            a.events.trigger("commands.after", w.merge([e], t || [])),
            w.FE.COMMANDS[e] && !1 !== w.FE.COMMANDS[e].undo && a.undo.saveStep();
        }
      }
      function e(e, t) {
        a.format.toggle(t);
      ...
      function n(e) {
        ...
        for (var t = a.selection.blocks(), n = 0; n < t.length; n++)
          if ("LI" != t[n].tagName || "LI" != t[n].parentNode.tagName) {
            var r = w(t[n]);
            "LI" != t[n].tagName && "LI" == t[n].parentNode.tagName && (r = w(t[n].parentNode));
          ...
          a.events.on("keydown", function (e) {
            ...
            a.events.on("keyup", function (e) {
              ...
              if (t && "HR" == t.tagName)
                ...
                } else if ((e.which == w.FE.KEYCODE.ARROW_RIGHT || e.which == w.FE.KEYCODE.ARROW_DOWN) && t.nextSibling)
                  return a.node.isBlock(t.nextSibling) ? a.selection.setAtStart(t.nextSibling) : w(t).after(w.FE.MARKERS), a.selection.restore(), !1;
            }),
    ...
    (w.FE.MODULES.data = function (p) {
      ...
      function y(e) {
        for (
          var t = [v("9qqG-7amjlwq=="), v("KA3B3C2A6D1D5H5H1A3=="), v("3B9B3B5F3C4G3E3=="), v("QzbzvxyB2yA-9m=="), v("ji1kacwmgG5bc=="), v("nmA-13aogi1A3c1jd=="), v("BA9ggq=="), v("emznbjbH3fij=="), v("tkC-22d1qC-13sD1wzF-7==")], n = 0;
          n < t.length;
          n++
        )
          if (
    ...
    w.extend(w.FE.DEFAULTS, { pastePlain: !1, pasteDeniedTags: ["colgroup", "col", "meta"], pasteDeniedAttrs: ["class", "id", "style"], pasteAllowedStyleProps: [".*"], pasteAllowLocalImages: !1 }),
    (w.FE.MODULES.paste = function (C) {
      ...
      function t(e) {
        ...
        if ((C.$win.scrollTop(), e && e.clipboardData && e.clipboardData.getData)) {
          ...
          if (C.helpers.isArray(n)) for (var r = 0; r < n.length; r++) t += n[r] + ";";
          else t = n;
          if (
            ((A = ""),
            /text\/rtf/.test(t) && (a = e.clipboardData.getData("text/rtf")),
            /text\/html/.test(t) && !C.browser.safari ? (A = e.clipboardData.getData("text/html")) : /text\/rtf/.test(t) && C.browser.safari ? (A = a) : /public.rtf/.test(t) && C.browser.safari && (A = e.clipboardData.getData("text/rtf")),
            "" !== A)
          )
        ...
        return (
          (function () {
            C.selection.save(),
              ...
              (A = null),
              o
                ? (o.html(""), C.browser.edge && C.opts.iframe && C.$el.append(o))
                : ((o = w(
                  ...
                  C.browser.webkit || C.browser.mozilla ? (o.css("top", C.$sc.scrollTop()), C.$el.after(o)) : C.browser.edge && C.opts.iframe ? C.$el.append(o) : C.$box.after(o),
        ...
        if ((e.originalEvent && (e = e.originalEvent), e && e.dataTransfer && e.dataTransfer.getData)) {
          ...
          if (
            ...
            /text\/html/.test(t)
              ...
              : /text\/rtf/.test(t) && C.browser.safari
              ? (A = a)
              : /text\/plain/.test(t) && !this.browser.mozilla && (A = C.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")),
            "" !== A)
          ) {
            ...
            if (
              (C.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-placeholder"),
              C.$el.find(".fr-marker-helper").addClass("fr-marker").removeClass("fr-marker-helper"),
              C.selection.restore(),
              C.selection.remove(),
              C.$el.find(".fr-marker-placeholder").addClass("fr-marker").removeClass("fr-marker-placeholder"),
              !1 !== o)
            ) {
      ...
      function s() {
        C.opts.iframe && C.$el.attr("contenteditable", "true"),
          C.browser.edge && C.opts.iframe && C.$box.after(o),
          x || (C.keys.forceUndo(), (x = C.snapshot.get())),
          A || ((A = o.get(0).innerHTML), C.selection.restore(), C.events.enableBlur());
      ...
      function l(r, e, t) {
        ...
        if (0 <= r.toLowerCase().indexOf("<body")) {
          var a = "";
          0 <= r.indexOf("<style") && (a = r.replace(/[.\s\S\w\W<>]*(<style[^>]*>[\s]*[.\s\S\w\W<>]*[\s]*<\/style>)[.\s\S\w\W<>]*/gi, "$1")),
            (r = a + r.replace(/[.\s\S\w\W<>]*<body[^>]*>[\s]*([.\s\S\w\W<>]*)[\s]*<\/body>[.\s\S\w\W<>]*/gi, "$1"));
          var s = 0,
            l = "";
        ...
        if (!e)
          if (
            ...
            c && (r = C.win.localStorage.getItem("fr-copied-html")),
            f && ((c = !0), (r = C.win.localStorage.getItem("fr-dragged-content-html"))),
            c)
          )
            r = C.clean.html(r, C.opts.pasteDeniedTags, C.opts.pasteDeniedAttrs);
          else {
            var p = C.opts.htmlAllowedStyleProps;
            (C.opts.htmlAllowedStyleProps = C.opts.pasteAllowedStyleProps),
              (C.opts.htmlAllowComments = !1),
              (r = (r = (r = r.replace(/<span class="Apple-tab-span">\s*<\/span>/g, $(C.opts.tabSpaces || 4))).replace(/<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g, function (e, t) {
                return $(t.length * (C.opts.tabSpaces || 4));
              })).replace(/\t/g, $(C.opts.tabSpaces || 4))),
              (r = C.clean.html(r, C.opts.pasteDeniedTags, C.opts.pasteDeniedAttrs)),
              (C.opts.htmlAllowedStyleProps = p),
              (C.opts.htmlAllowComments = !0),
              (r = (r = (r = O(r)).replace(/\r/g, "")).replace(/^ */g, "").replace(/ *$/g, ""));
          }
        !e ||
          (C.wordPaste && t) ||
          ...
          (r = O(
            (r = (function (e) {
              ...
              (e = (e = e.replace(/<lilevel([^1])([^>]*)>/gi, '<li data-indent="true"$2>')).replace(/<lilevel1([^>]*)>/gi, "<li$1>")),
                (e = (e = (e = C.clean.html(e, C.opts.pasteDeniedTags, C.opts.pasteDeniedAttrs)).replace(/<a>(.[^<]+)<\/a>/gi, "$1")).replace(/<br> */g, "<br>"));
        ...
        if (("string" == typeof u && (r = u), "" !== r)) {
          ...
          if (C.opts.enter == w.FE.ENTER_BR) for (n = (o = g.querySelectorAll("p, div")).length - 1; 0 <= n; n--) 0 === (i = o[n]).attributes.length && (i.outerHTML = i.innerHTML + (i.nextSibling && !C.node.isEmpty(i) ? "<br>" : ""));
          else if (C.opts.enter == w.FE.ENTER_DIV) for (n = (o = g.getElementsByTagName("p")).length - 1; 0 <= n; n--) 0 === (i = o[n]).attributes.length && (i.outerHTML = "<div>" + i.innerHTML + "</div>");
      ...
      return {
        _init: function () {
          C.el.addEventListener("copy", e),
            C.el.addEventListener("cut", e),
            C.el.addEventListener("paste", t, { capture: !0 }),
            C.events.on("drop", r),
            C.browser.msie &&
              ...
              C.events.on("beforepaste", t)),
            C.events.on("dragstart", c, !0),
            C.events.on("destroy", f);
        },
    ...
    w.extend(w.FE.DEFAULTS, { shortcutsEnabled: [], shortcutsHint: !0 }),
    (w.FE.SHORTCUTS_MAP = {}),
    (w.FE.RegisterShortcut = function (e, t, n, r, o, i) {
      (w.FE.SHORTCUTS_MAP[(o ? "^" : "") + (i ? "@" : "") + e] = { cmd: t, val: n, letter: r, shift: o, option: i }), w.FE.DEFAULTS.shortcutsEnabled.push(t);
    }),
    w.FE.RegisterShortcut(w.FE.KEYCODE.E, "show", null, "E", !1, !1),
    w.FE.RegisterShortcut(w.FE.KEYCODE.B, "bold", null, "B", !1, !1),
    w.FE.RegisterShortcut(w.FE.KEYCODE.I, "italic", null, "I", !1, !1),
    w.FE.RegisterShortcut(w.FE.KEYCODE.U, "underline", null, "U", !1, !1),
    w.FE.RegisterShortcut(w.FE.KEYCODE.S, "strikeThrough", null, "S", !1, !1),
    w.FE.RegisterShortcut(w.FE.KEYCODE.CLOSE_SQUARE_BRACKET, "indent", null, "]", !1, !1),
    w.FE.RegisterShortcut(w.FE.KEYCODE.OPEN_SQUARE_BRACKET, "outdent", null, "[", !1, !1),
    w.FE.RegisterShortcut(w.FE.KEYCODE.Z, "undo", null, "Z", !1, !1),
    w.FE.RegisterShortcut(w.FE.KEYCODE.Z, "redo", null, "Z", !0, !1),
    w.FE.RegisterShortcut(w.FE.KEYCODE.Y, "redo", null, "Y", !1, !1),
    (w.FE.MODULES.shortcuts = function (l) {
      var r = null;
      var d = !1;
      function e(e) {
        ...
        if ("keyup" == e.type && d && t != w.FE.KEYCODE.META) return (d = !1);
        "keydown" == e.type && (d = !1);
        var r = (e.shiftKey ? "^" : "") + (e.altKey ? "@" : "") + t,
          o = l.node.blockParent(l.selection.blocks()[0]);
        if (n && w.FE.SHORTCUTS_MAP[r] && (!o || "false" != w(o).attr("contenteditable"))) {
          var i = w.FE.SHORTCUTS_MAP[r].cmd;
          if (i && 0 <= l.opts.shortcutsEnabled.indexOf(i)) {
            var a,
              s = w.FE.SHORTCUTS_MAP[r].val;
            ...
            if (i && (l.commands[i] || (w.FE.COMMANDS[i] && w.FE.COMMANDS[i].callback))) return e.preventDefault(), e.stopPropagation(), "keydown" == e.type && ((l.commands[i] || w.FE.COMMANDS[i].callback)(), (d = !0)), !1;
          }
        }
      }
      return {
        ...
        get: function (e) {
          ...
          if (!r)
            for (var t in ((r = {}), w.FE.SHORTCUTS_MAP))
              w.FE.SHORTCUTS_MAP.hasOwnProperty(t) &&
                0 <= l.opts.shortcutsEnabled.indexOf(w.FE.SHORTCUTS_MAP[t].cmd) &&
                (r[w.FE.SHORTCUTS_MAP[t].cmd + "." + (w.FE.SHORTCUTS_MAP[t].val || "")] = { shift: w.FE.SHORTCUTS_MAP[t].shift, option: w.FE.SHORTCUTS_MAP[t].option, letter: w.FE.SHORTCUTS_MAP[t].letter });
          var n = r[e];
          return n
    ...
    w.extend(w.FE.DEFAULTS, { iconsTemplate: "font_awesome" }),
    ...
    w.extend(w.FE.DEFAULTS, { tooltips: !0 }),
    (w.FE.MODULES.tooltip = function (o) {
      ...
      function i(e, t) {
        ...
        o.$tooltip ||
          (o.opts.tooltips &&
            ...
            (o.shared.$tooltip
              ...
              : ((o.shared.$tooltip = w('<div class="fr-tooltip"></div>')), (o.$tooltip = o.shared.$tooltip), o.opts.theme && o.$tooltip.addClass(o.opts.theme + "-theme"), w(o.o_doc).find("body:first").append(o.$tooltip)),
            o.events.on(
              "shared.destroy",
              function () {
        ...
        n < 0 && (n = 0),
          n + o.$tooltip.outerWidth() > w(o.o_win).width() && (n = w(o.o_win).width() - o.$tooltip.outerWidth()),
          void 0 === t && (t = o.opts.toolbarBottom),
          e.offset().top - w(window).scrollTop() + e.outerHeight() + 10 >= w(window).height() && (t = !0);
        ...
        o.$tooltip.css("position", ""),
          ...
          "static" != w(o.o_doc).find("body:first").css("position")
            ? (o.$tooltip.css("margin-left", -w(o.o_doc).find("body:first").offset().left), o.$tooltip.css("margin-top", -w(o.o_doc).find("body:first").offset().top))
    ...
    (w.FE.MODULES.button = function (u) {
      ...
      function t(e) {
        ...
        u.node.hasClass(e.get(0), "fr-dropdown")
          ? (function (e) {
              ...
              if ((o.helpers.isIOS() && !o.el.querySelector(".fr-marker") && (o.selection.save(), o.selection.clear(), o.selection.restore()), !n)) {
                ...
                t.find(".fr-command").removeClass("fr-active").attr("aria-selected", !1),
                  w.FE.COMMANDS[i] && w.FE.COMMANDS[i].refreshOnShow && w.FE.COMMANDS[i].refreshOnShow.apply(o, [e, t]),
                ...
                t.removeClass("test-height"),
                  ...
                  !u.opts.toolbarBottom && t.offset().top + e.outerHeight() + a < w(u.o_doc).height()
                    ? t.css("top", e.position().top + e.outerHeight())
          ...
          : (r(e), w.FE.COMMANDS[e.data("cmd")] && !1 !== w.FE.COMMANDS[e.data("cmd")].refreshAfterCallback && t.button.bulkRefresh());
      }
      function i(e) {
        t(w(e.currentTarget));
      }
        ...
        setTimeout(function () {
          for (var e = i.selection.inEditor() && i.core.hasFocus(), t = 0; t < o.length; t++) {
            ...
            0 === n.parents(".fr-popup").length
              ? e || (w.FE.COMMANDS[r] && w.FE.COMMANDS[r].forcedRefresh)
                ? i.button.refresh(n)
      ...
      return {
        ...
        bindCommands: function (t, e) {
          ...
          u.events.$on(w(r), u._mouseup + " resize keydown", o, !0),
            u.opts.iframe && u.events.$on(u.$win, u._mouseup, o, !0),
            u.node.hasClass(t.get(0), "fr-popup") ? w.merge(s, t.find(".fr-btn").toArray()) : w.merge(a, t.find(".fr-btn").toArray()),
        ...
        refresh: function (e) {
          ...
          u.node.hasClass(e.get(0), "fr-dropdown") ? (t = e.next()) : (e.removeClass("fr-active"), e.attr("aria-pressed") && e.attr("aria-pressed", !1)),
            w.FE.COMMANDS[r] && w.FE.COMMANDS[r].refresh ? w.FE.COMMANDS[r].refresh.apply(n, [e, t]) : u.refresh[r] && n.refresh[r](e, t);
        },
        bulkRefresh: n,
        exec: r,
        click: t,
          ...
          if ((l.shared.$overlay || (l.shared.$overlay = w('<div class="fr-overlay">').appendTo("body:first")), (s = l.shared.$overlay), l.opts.theme && s.addClass(l.opts.theme + "-theme"), !d[n])) {
            ...
            (d[n] = { $modal: r, $head: r.find(".fr-modal-head"), $body: r.find(".fr-modal-body") }),
              ...
              l.events.$on(
                ...
                function (e) {
                  var t = e.which;
                  return t == w.FE.KEYCODE.ESC
                    ? (c(n), l.accessibility.focusModalButton(r), !1)
                    : !(!w(e.target).is("input[type=text], textarea") && t != w.FE.KEYCODE.ARROW_UP && t != w.FE.KEYCODE.ARROW_DOWN && !l.keys.isBrowserAction(e) && (e.preventDefault(), e.stopPropagation(), 1));
                },
                !0
              ),
              c(n, !0);
        ...
        show: function (e) {
          if (d[e]) {
            ...
            t.data("instance", l),
              t.show(),
              s.show(),
              w(l.o_doc).find("body:first").addClass("prevent-scroll"),
              l.helpers.isMobile() && w(l.o_doc).find("body:first").addClass("fr-mobile"),
    ...
    (w.FE.POPUP_TEMPLATES = { "text.edit": "[_EDIT_]" }),
    ...
    (w.FE.MODULES.popups = function (c) {
      ...
      function o(e, t) {
        ...
        return o
          ? ((n = w('<div class="fr-popup' + (c.helpers.isMobile() ? " fr-mobile" : " fr-desktop") + (c.opts.toolbarInline ? " fr-inline" : "") + '"><span class="fr-arrow"></span>' + o + "</div>")),
            ...
            (r = w("body:first")).append(n),
            n.data("container", r),
            (f[e] = n),
            c.button.bindCommands(n, !1),
            n)
          : ((n = w('<div class="fr-popup fr-empty"></div>')), (r = w("body:first")).append(n), n.data("container", r), (f[e] = n));
      }
      function E(r) {
        var o = f[r];
        return {
          ...
          _preventFocus: function (e) {
            ...
            "mouseup" == e.type || w(n).is(":focus") || t.events.disableBlur(),
              "mouseup" != e.type || w(n).hasClass("fr-command") || 0 < w(n).parents(".fr-command").length || w(n).hasClass("fr-dropdown-content") || c.button.hideActiveDropdowns(o),
              (c.browser.safari || c.browser.mozilla) && "mousedown" == e.type && w(n).is("input[type=file]") && t.events.disableBlur();
        ...
        (c.shared.exit_flag = !1),
        {
          _init: function () {
            c.events.on("shared.destroy", e, !0),
              ...
              c.events.$on(w(c.o_win), "scroll", m),
          ...
          create: function (e, t) {
            ...
            return (
              ...
              c.events.$on(w(c.o_win), "resize", r._windowResize, !0),
              n
            );
          },
          get: function (e) {
        ...
        if (e.offsetWidth) {
          ...
          m || E
            ...
            : v.node.hasClass(r.get(0), "fr-sticky-off") ||
              (r.width(""), r.removeClass("fr-sticky-on"), r.addClass("fr-sticky-off"), r.css("top") && "auto" != r.data("top") && a.top && r.css("top", 0), r.css("bottom") && "auto" != r.data("bottom") && a.bottom && r.css("bottom", 0));
        }
      }
      function e() {
        ...
        _init: function () {
          !(function () {
            if (((v._stickyElements = []), v.helpers.isIOS())) {
              ...
              "body" !== v.opts.scrollableContainer && v.events.$on(w(v.opts.scrollableContainer), "scroll", e, !0),
                v.events.$on(w(v.o_win), "scroll", e, !0),
                v.events.$on(w(v.o_win), "resize", e, !0),
                v.events.on("initialized", e),
                v.events.on("focus", e),
                v.events.$on(w(v.o_win), "resize", "textarea", e, !0);
    ...
    w.extend(w.FE.DEFAULTS, { editInPopup: !1 }),
    ...
    (w.FE.TOOLBAR_BUTTONS_MD = null),
    (w.FE.TOOLBAR_BUTTONS_SM = ["bold", "italic", "underline", "|", "fontFamily", "fontSize", "insertLink", "insertImage", "table", "|", "undo", "redo"]),
    (w.FE.TOOLBAR_BUTTONS_XS = ["bold", "italic", "fontFamily", "fontSize", "|", "undo", "redo"]),
    (w.FE.MODULES.toolbar = function (o) {
      var r = [];
      function i(e, t) {
      ...
      function t(e, t) {
        setTimeout(function () {
          if (
            (!e || e.which != w.FE.KEYCODE.ESC) &&
            o.selection.inEditor() &&
            o.core.hasFocus() &&
            !o.popups.areVisible() &&
            /**
             * This particular line is a fix from 2.9.8 that I've
             * manually back ported to this library.
             */
            // o.selection.blocks().length &&
            "false" != w(o.selection.blocks()[0]).closest("table").attr("contenteditable") &&
      ...
      (r[w.FE.XS] = o.opts.toolbarButtonsXS || o.opts.toolbarButtons || w.FE.TOOLBAR_BUTTONS_XS || w.FE.TOOLBAR_BUTTONS || []),
        (r[w.FE.SM] = o.opts.toolbarButtonsSM || o.opts.toolbarButtons || w.FE.TOOLBAR_BUTTONS_SM || w.FE.TOOLBAR_BUTTONS || []),
        (r[w.FE.MD] = o.opts.toolbarButtonsMD || o.opts.toolbarButtons || w.FE.TOOLBAR_BUTTONS_MD || w.FE.TOOLBAR_BUTTONS || []),
        (r[w.FE.LG] = o.opts.toolbarButtons || w.FE.TOOLBAR_BUTTONS || []);
      var s = null;
      function l(e) {
      ...
      function p() {
        o.opts.theme && o.$tb.addClass(o.opts.theme + "-theme"),
          ...
          o.events.$on(w(o.o_win), "resize", e),
          o.events.$on(w(o.o_win), "orientationchange", e),
      ...
      return {
        _init: function () {
          ...
          o.opts.toolbarContainer
            ? (o.shared.$tb ? ((o.$tb = o.shared.$tb), o.opts.toolbarInline && d()) : ((o.shared.$tb = w('<div class="fr-toolbar"></div>')), (o.$tb = o.shared.$tb), w(o.opts.toolbarContainer).append(o.$tb), p(), o.$tb.data("instance", o)),
            ...
            : o.opts.toolbarInline
            ? (o.$box.addClass("fr-inline"), o.shared.$tb ? ((o.$tb = o.shared.$tb), d()) : ((o.shared.$tb = w('<div class="fr-toolbar"></div>')), (o.$tb = o.shared.$tb), p()))
            // ? (o.$box.addClass("fr-inline"), o.shared.$tb ? ((o.$tb = o.shared.$tb), d(), o.button.bindCommands(o.$tb)) : ((o.shared.$tb = w('<div class="fr-toolbar"></div>')), (o.$tb = o.shared.$tb), p()))
            : (o.$box.addClass("fr-basic"), (o.$tb = w('<div class="fr-toolbar"></div>')), p(), o.$tb.data("instance", o)),
